<template>
  <nav class="container flex justify-between items-center xl:px-8 py-4 mx-auto">
    <div>
    ...
    <div class="mynav-inner mr-auto">
      ...
      <router-link to="/appoint_my">我的預約</router-link> |
      <router-link to="/appoint_all">所有預約</router-link>
    </div>
    <div>
